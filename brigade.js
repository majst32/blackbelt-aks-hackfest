...
events.on("push", (brigadeEvent, project) => {
    ...
    brigConfig.set("webImage", "missyj/web")
...
function kubeJobRunner (config, k) {
    ...
    k.tasks = [
        `kubectl set image deployment/heroes-web-deploy heroes-web-cntnr=newmjcontreg.azurecr.io/missyj/web:${config.get("imageTag")}`
    ]
}
